...
export function PropertySetupPage() {
  ...
  const pricingRulesState = useAsync(
    async () =>
      unwrapList((await api.get<PaginatedResponse<PricingRule>>('/pricing-rules', { params: { limit: 100 } })).data),
    [reloadKey],
  );
  ...
  return (
    <section>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Create properties, room categories, and rate plans before adding physical rooms or opening inventory.
          </p>
        </div>
      </div>
      ...
      <div className="info-strip">
        ...
        <span>
          Build the property, category, rate, media, and pricing layers in that order. Dynamic pricing rules apply on top of each rate plan base.
        </span>
      </div>
